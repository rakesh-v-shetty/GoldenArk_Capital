...
def get_trading_data():
    ...
    try:
        ...
        # Limit to a maximum of 4 slides as requested (24 rows total)
        # If trading.csv has more than 24 rows, only the first 24 will be used.
        # If report.csv has less than 4 rows, it will use what's available.
        effective_num_slides = min(num_slides, 4)
...
if __name__ == '__main__':
    ...
    # On Render, Gunicorn (as defined in Procfile) will run the app.
